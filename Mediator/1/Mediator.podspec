...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/ModuleLovePlay/Mediator"
  ...
  s.source       = { :git => "https://github.com/ModuleLovePlay/Mediator.git", :tag => s.version.to_s }
  ...
  s.source_files  = "Mediator/Mediator/**/*.{h,m}"
